...
class TrackNumberSource: RowSource {
    ...
    public func configureCell(_ cell: TrackNumberViewCell) {
        cell.object = data
    ...
    func tracks(with objects: [Any], parentObject: Any) -> [TrackNumberSource] {
        var list = [TrackNumberSource]()
    ...
    func track(with object: Any, parentObject: Any) -> TrackNumberSource {
        let source = TrackNumberSource()
        source.data = object
