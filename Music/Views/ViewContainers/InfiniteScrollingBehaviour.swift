...
public protocol InfiniteScrollingBehaviourDelegate: class {
    func configuredCell(forItemAtIndexPath indexPath: IndexPath, originalIndex: Int, andData data: Any, forInfiniteScrollingBehaviour behaviour: InfiniteScrollingBehaviour) -> UICollectionViewCell
    func didSelectItem(atIndexPath indexPath: IndexPath, originalIndex: Int, andData data: Any, inInfiniteScrollingBehaviour behaviour: InfiniteScrollingBehaviour) -> Void
...
public class InfiniteScrollingBehaviour: NSObject {
    ...
    fileprivate(set) public var dataSet: [Any]
    fileprivate(set) public var dataSetWithBoundary: [Any] = []
    ...
    public init(withCollectionView collectionView: UICollectionView, andData dataSet: [Any], delegate: InfiniteScrollingBehaviourDelegate, configuration: CollectionViewConfiguration = .default) {
    ...
    public func reload(withData dataSet: [Any]) {
        self.dataSet = dataSet
        configureBoundariesForInfiniteScroll()
...
extension InfiniteScrollingBehaviour: UICollectionViewDelegateFlowLayout {
    ...
    public func scrollViewDidEndDragging(_ scrollView: UIScrollView, willDecelerate decelerate: Bool) {
      ...
      //  let originalIndex = indexInOriginalDataSet(forIndexInBoundaryDataSet: currentPage)
    }
        ...
        if contentOffsetValue >= (scrollViewContentSizeValue - boundarySize) {
            ...
            let updatedOffsetPoint = collectionConfiguration.scrollingDirection == .horizontal ?
             ...
             DispatchQueue.main.async {
                scrollView.setContentOffset(updatedOffsetPoint, animated: false)
            }
